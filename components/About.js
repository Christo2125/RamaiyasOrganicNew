            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="text-center mb-20 reveal">
                    ...
                    <p class="text-gray-600 text-xl max-w-2xl mx-auto leading-relaxed">
                       As all we commonly know that UDANKUDI is famously know for KARUPATI .... And it's Trade Mark ‼️‼️ 
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24">
                    <div class="reveal active bg-white rounded-[3rem] p-12 shadow-xl shadow-brand-green/5 flex flex-col justify-center">
                        <h2 class="text-3xl font-serif font-bold text-brand-dark mb-6">Our Farm & Heritage</h2>
...
Our outlet for all our products are in Udankudi Market which is more than 80yrs old and a 4 th generation is also in same business.... Which prescribes the quality and value of the product we deliver in market...
                        </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
                    <div class="reveal bg-gradient-to-br from-emerald-50 to-emerald-100/40 rounded-3xl p-8 relative overflow-hidden group h-[400px] flex flex-col justify-between border border-emerald-100/50">
                        <div>
                            ...
                            <h3 class="text-2xl font-serif font-bold text-brand-dark mt-4">Direct Market <br/> Distribution</h3>
                        </div>
                        <p class="text-gray-600 text-sm relative z-10 font-medium">Now we the 4th Gen Coming to the direct market distribution with out any middle man ....where people can get quality product in very reasonable price and quality ....
                        ...
                        <div>
                            ...
                            <ul class="space-y-6">
                                ...
                                <li class="flex items-center gap-4">
                                    ...
                                    <span class="text-lg font-medium uppercase">Karupatti ‼️‼️</span>
                                </li>
                            </ul>
                        </div>
